public class PhysicsSolver {
    ...
    public static class Slot {
        private double v;
        private boolean yesValue = false;
        /**
        ...
        public boolean hasValue() {
             if (yesValue == false)return false;
             return true;
        }
        ...
        public double getValue() {
            if (yesValue == false) throw new RuntimeException("slot without a value");
            return v;
        }
        ...
        public boolean setValue(double value) {
             ...
             throw new RuntimeException("trying to store a different value in the slot");
        }
        /**
    ...
    public static class Squaring extends Relation {
        ...
        public boolean update() {
            ...
            } else if (!number_.hasValue() && square_.hasValue()) {
