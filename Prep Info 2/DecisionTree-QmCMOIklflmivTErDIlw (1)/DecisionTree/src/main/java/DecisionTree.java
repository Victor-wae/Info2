public abstract class DecisionTree {
    ...
    public static DecisionTree splitNode(int featureIndex, DecisionTree left, DecisionTree right) {
         return new DecisionTreeImpl(featureIndex,left,right) ;
    }
     ...
     * @return a decision tree that always predicts label
     */
    public static DecisionTree decisionNode(boolean label) {return new DecisionNode(label);}
    public static class DecisionNode extends DecisionTree{
        boolean leaf;

        public DecisionNode(boolean leaf) {
            this.leaf = leaf;
        }
    ...
    public static class DecisionTreeImpl extends DecisionTree{
        DecisionTree left;
        DecisionTree right;
        int root;

        public DecisionTreeImpl( int root, DecisionTree left, DecisionTree right) {
            this.left = left;
            this.right = right;
            this.root = root;
        }
